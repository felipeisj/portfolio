...
const About = () => {
  return (
    <div className="w-full  px-[2.5rem]">
      <h1 className="text-5xl text-white font-bold p-4 text-center">About me</h1>
      <div className="about-cards flex gap-10 flex-col md:flex-row font-bold">
        ...
        <Card title="Hobbies" imageUrl="vite.svg" content={
          <h1 className="text-2xl font-bold pr-4 my-auto text-white">
